...
To use the image you must push it to your Google Artifact Registry after pulling it. But if you'd rather have a detailed guide, here is how to do it:
...
- [Api documentation](./doc/api-doc.md) - Detailed explanation of all JSON fields and Application logic
